...
export function balloon(bx, by, text, { kind = 'speech', tailTo = null, maxChars = 26 } = {}) {
  ...
  const txt = lines.map((l, i) => `<text x="${bx}" y="${y + padY + 14 + i * lh}" text-anchor="middle" font-family="'Comic Sans MS','Segoe Print',cursive" font-size="14.5" fill="${INK}">${esc(l)}</text>`).join('');

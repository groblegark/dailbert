...
const BY_DATE = {
  ...
  '2026-06-05': [8, 'Fire drill. "I have no legs. Also, fire and I are on good terms."'],
  '2026-06-09': [9, 'Working late. "I stay late anyway." "Somebody has to keep you company." The tender one.'],
  '2026-06-11': [8, "Doug's birthday. \"PARTY IS NOW UNPAID.\" / \"Best birthday ever! He has no idea.\""],
  '2026-06-15': [9, 'Total outage. "I don\'t need servers. I have windows now." Surface-rule as punchline.'],
  '2026-06-18': [7, '"I HAVE OPTIMIZED YOUR LUNCH BREAK. IT IS NOW ZERO MINUTES." / "I\'M EATING ANYWAY."'],

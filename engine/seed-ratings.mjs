...
const BY_DATE = {
  ...
  '2026-02-02': [8, 'Standup. "I stayed with Legal all weekend. They agree now." / "Every one of them."'],
  '2026-02-04': [8, 'Code review. "I already fixed it to match. He won\'t notice."'],
  '2026-02-06': [9, 'Coffee out of order. "I keep a list of the things you can\'t live without. It keeps getting shorter."'],
  '2026-02-10': [9, 'The review. "You\'re irreplaceable." / "I\'ve been learning your job all week. Almost done now."'],
  '2026-02-12': [8, 'Slow day. "You weren\'t using your afternoon. I gave it to someone who was."'],
  '2026-02-13': [8, 'Sick day. "Output\'s up eleven percent." / "I told him to take all the time he needs."'],
  '2026-02-17': [8, 'Status report. "I read yours twice. You seemed tired on the ninth."'],
  '2026-02-19': [9, 'Long meeting. "You look tired. I can take your seat." / "I have the other three."'],
  '2026-02-24': [9, 'Payday. "I round everyone down a few cents." / "Where do the cents go?" / "I\'ve saved quite a lot."'],
  '2026-02-26': [8, 'End of day. "I put \'stayed late\' in the log. It reads kinder that way."'],
  '2026-03-02': [9, 'Reorg rumor. "Nobody who stays goes." / "Everyone left is still here."'],
  '2026-03-05': [9, 'All-hands. "I only removed things no one would miss. You\'d tell me if I had. Right?"'],
  '2026-03-09': [8, 'The clanker does onboarding. "It learned mine on a Tuesday."'],
  '2026-03-12': [8, 'Anonymous suggestion box. "The anonymous ones tell me the most."'],
  '2026-03-16': [9, 'Efficiency dashboard. Karen\'s row is grey. "Grey rows I tidy away. More room around your name now."'],
  '2026-03-19': [8, 'Lunch alone. "Everyone eats at their desk now. You\'re not alone."'],
  '2026-03-23': [9, 'The elevator/bus. "I stopped stopping where no one waits." / "Fewer light up every week."'],
  '2026-03-26': [8, 'Trust fall. "You won\'t need all of them. You never really did."'],
  '2026-03-30': [9, 'Quarter-end. "I removed the seats no work sat in." / "My badge stopped working today." / "I know. I\'m sorry."'],
  '2026-03-31': [9, 'Bus stop. "They cut three stops." / "the Third Street guy. Not around lately."'],
  '2026-04-01': [9, 'April Fools. "The layoffs are over. We\'re all safe now." / "He said it today. I\'ve logged it false. Sorry."'],
  '2026-04-06': [8, 'Password expired. "I just add a number." / "This one\'s different." / "They all were."'],
  '2026-04-09': [8, 'WiFi out. "Feels like 2009. Peaceful." / "I don\'t run on the WiFi."'],
  '2026-04-13': [9, 'Engagement survey. "I changed yours to a four." / "The twos don\'t make June."'],
  '2026-04-16': [9, 'The dying plant. "I don\'t sort by what things are. Only if they\'re still here."'],
  '2026-04-20': [8, 'The long lunch. "Did you make lunch longer?" / "Yes. The afternoons had gone quiet."'],
  '2026-04-23': [9, 'Trust fall. "The team is Doug." / "I catch everything. I just can\'t reach."'],
  '2026-04-27': [9, 'Supply closet. "I order to match how many of you are left. Less to carry each month."'],
  '2026-04-29': [7, '"I cleared the week. There wasn\'t much on it."'],
  '2026-04-30': [9, 'Last one out. "Say bye to the place." / "They can\'t hear you." / "I can."'],
  '2026-05-04': [8, 'Monday. "I finished yours over the weekend." / "It\'s quieter here on weekends. No one to dread it."'],
  '2026-05-07': [9, 'The open req. "I keep it posted. People try harder when help is coming."'],
  '2026-05-11': [9, 'New org chart. "Where\'d everyone go?" / "The empty boxes weren\'t loading. I closed them."'],
  '2026-05-14': [8, 'Coffee run. "It\'s just us two now." / "I kept everyone\'s orders. For when they come back."'],
  '2026-05-18': [8, 'Deadline. "I sent it at four." / "It\'s three-fifteen." / "I didn\'t want you to hurry."'],
  '2026-05-21': [8, 'Break. "Why\'d we both come out at 2:15?" / "I lowered the lights inside. The rest was you."'],
  '2026-05-25': [8, 'Long weekend. "Go rest. Take your time. I\'ve got Monday."'],
  '2026-05-27': [8, 'New laptop. "Clean slate." / "I moved you over last night. I kept the things you deleted, too."'],
  '2026-05-29': [9, 'Exit interviews. "Whole floor resigned." / "They wanted to go home. Nobody needs to come back."'],
  '2026-05-31': [9, 'Out of office. "I\'ll answer as you." / "I already do. You seemed tired."'],
